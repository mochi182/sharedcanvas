defmodule SharedcanvasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SharedcanvasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SharedcanvasWeb.Gettext, "errors", msg, opts)
    end
  end
